class n extends HTMLElement {
  static preload() {
    import("./connect.js?module").then(function (n) {
      return n.c;
    });
  }
  connectedCallback() {
    ...
    if (
      ...
      !n.isSupported || !n.isAllowed)
    )
      return (
        this.toggleAttribute("install-unsupported", !0),
        void (this.renderRoot.innerHTML = n.isAllowed
          ? "<slot name='unsupported'>Your browser does not support installing things on WiC64 devices. Use Google Chrome, Microsoft Edge or Opera.</slot>"
          : "<slot name='not-allowed'>You can only install WiC64 devices on HTTPS websites or on the localhost.</slot>")
      );
    ...
    (e.addEventListener("click", async (n) => {
      n.preventDefault();
      (
        await import("./connect.js?module").then(function (n) {
          return n.c;
        })
      ).connect(this);
    }),
